...
from .storage import (
    ...
    add_history, list_history, add_template, list_templates)
...
@app.post("/api/ml_test")
def ml_test(payload: MlTestRequest):
    return {"items": predict_labels(payload.fragments)}
