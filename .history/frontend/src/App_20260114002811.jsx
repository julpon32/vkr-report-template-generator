        ...
        <div>
          ...
          {rules && (
            <div style={{ marginTop: 14, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
              ...
              <div className="card">
                <div className="cardTitle">Что нашлось автоматически</div>
                <pre className="codebox">{JSON.stringify(rules.raw_matches ?? {}, null, 2)}</pre>

                <div className="spacer" />
                <div className="cardTitle">Полный JSON</div>
